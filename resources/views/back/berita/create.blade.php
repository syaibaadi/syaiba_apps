          ...
          <div class="col-12">
            ...
            <div class="form-group">
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control" name="isi" id="Isi Berita" rows="3"></textarea>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" readonly class="form-control-plaintext" id="staticEmail" name="penulis" value="{{{ isset(Auth::user()->name) ? Auth::user()->name : Auth::user()->email }}}">
              </div>
              <div class="mb-3">
