  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <form action="/simpan-inventaris" method="POST" enctype="multipart/form-data">
              @csrf
            <div class="form-group">
              <div class="mb-3">
                <label for="Judul" class="form-label">Nama Barang</label>
                <input type="text" class="form-control" name="nama" id="Judul" placeholder="Judul">
              </div>
              <div class="mb-3">
                <label for="Isi Berita" class="form-label">Deskripsi Barang</label>
                <textarea class="form-control" name="diskripsi" id="Isi Berita" rows="3"></textarea>
              </div>
              <div class="mb-3">
