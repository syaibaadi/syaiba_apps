...
class InventarisController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('back.inventaris.index', compact('inventaris'));
    }
    ...
    {
        return view('back.inventaris.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $data = inventaris::create($validateData);
    ...
    public function edit($id)
    {
        ...
        return view('back.inventaris.edit', compact('inventaris'));
    }
